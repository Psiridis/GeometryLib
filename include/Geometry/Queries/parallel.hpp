...
namespace Geometry
{
	...
	/// Returns true if the line direction is parallel to the plane
	/// (i.e. the line cannot intersect the plane).
	[[nodiscard]] bool is_parallel(Line const& line, Plane const& plane) noexcept;

	/// Returns true if the segment direction is parallel to the plane
	/// (i.e. the segment cannot intersect the plane).
	[[nodiscard]] bool is_parallel(Segment const& segment, Plane const& plane) noexcept;
